...
@section('content')
            ...
            <div class="row g-0">
                <div class="col-md-7">
                    <img
                        ...
                        data-src="{{ asset('images/banners/Pureco-4.jpeg', ! config('app.debug')) }}" alt="banner hero"
                ...
                <div class="col-md">
                    <div style="background-color:#435057;" class="h-100 p-md-5 p-3 d-flex align-items-center">
                        <div>
                            <div class="mb-4">
                                <img src="{{ asset('images/pureco-logo.png', ! config('app.debug')) }}" alt="" class="img-fluid">
                            </div>
                            ...
                            <div data-aos="fade-down">
                                <img src="{{ asset('images/banner-baby-kids-family.png', ! config('app.debug')) }}" alt=""
    ...
    <img
        ...
        data-src="{{ asset('images/Pureco-All Product.jpeg', ! config('app.debug')) }}" alt="banner all products"
        class="img-fluid w-100 lozad">
            ...
            <div class="row align-items-center mt-3 justify-content-center">
                <div class="col-5 col-md-1 mb-3 mb-md-0">
                    <div data-aos="zoom-in">
                        <img src="{{ asset('images/icons/pbai.png', ! config('app.debug')) }}" alt="" class="img-fluid w-100">
                    </div>
                </div>
            ...
            <div class="row g-0">
                <div class="col-md-7">
                    <img
                        ...
                        data-src="{{ asset('images/banners/081A8674.jpeg', ! config('app.debug')) }}" alt="banner hero"
                        class="img-fluid w-100 lozad">
                </div>
                <div class="col-md">
                    <div style="background-color:#fff;" class="h-100 p-3 d-flex align-items-center">
                        <div class="overflow-hidden">
                            ...
                            <div data-aos="fade-left">
                                <img src="{{ asset('images/formulated-without.png', ! config('app.debug')) }}" alt=""
                        ...
                        @foreach($testimonials as $testimonial)
                            <div class="swiper-slide">
                                <div data-aos="fade-left" data-aos-delay="{{ $loop->index * 50 }}">
                                    <img src="{{ asset($testimonial->image_path, ! config('app.debug')) }}" alt="" class="img-fluid w-100">
                                </div>
                            </div>
                        @endforeach
                    </div>
    ...
    <section>
        <div class="container text-center mb-5 overflow-hidden">
            <div style="max-width: 800px" class="mx-auto my-5">
                <img src="{{ asset('images/baby-kids-family.png', ! config('app.debug')) }}" alt="" class="img-fluid w-100">
            </div>
        ...
        <img
            ...
            data-src="{{ asset('images/banners/081A8826.jpeg', ! config('app.debug')) }}" alt="banner hero"
            class="img-fluid w-100 lozad">
    </section>
